...
\section{Server}
	...
	\newline Attributes:
	\begin{itemize}
	\item int Id : The Id is used to identify each group and is therefore unique.
	\item String name : The name of a group is given by the founder and can be changed.
	\end{itemize}
	Methods:
	\begin{itemize}
	...
	\newline Attributes:
	\begin{itemize}
	\item int Id : The Id is used to identify each event and is therefore unique.
	\item String name : The name of an event is given by the creator.
	\item Time time : The time of an event tells when the event is starting and set by the creator of the event.
	\end{itemize}
	Methods:
	\begin{itemize}
	...
	\newline Attributes:
	\begin{itemize}
	\item int longitude : The longitude value of the position.
	\item int latitude : The latitude value of the position.
	\item String name : The name of a location helps the user to identify if the location is a center point of the group or the original meeting point.
	\end{itemize}
	Methods:
	\begin{itemize}
