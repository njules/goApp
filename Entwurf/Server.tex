...
\hypertarget{database.management}{}
	...
	\subsubsection{GroupManagement implements Management}
This class manages the access to the group table.
	...
	\subsubsection{UserManagement implements Management}
	...
	\subsubsection{EventManagement implements Management}
This class manages the access to the Event table.
	...
	\subsubsection{EventUserManagement implements Management}
This class manages the access to the Event-User table.
	...
	\subsubsection{GroupUserManagement implements Management}
	This class manages the access to the Group-User table.
		...
		\newpage
	\subsubsection{RequestManagement implements Management}
