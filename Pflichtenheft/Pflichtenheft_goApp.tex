...
\begin{document}
	...
	\begin{itemize}
		...
		\item Ein Benutzer kann Mitglied mehrerer Gruppen sein und kann Name, Mitglieder, Gründer und Termine einsehen.
	...
	\begin{itemize}
		...
		\item[FA150] Jeder Teilnehmer kann den Gruppenstandort ab 15 Minuten in einer Karte darstellen lassen.
		\item[FA155W] Vom Gruppenmittelpunkt entfernte Teilgruppen  erhalten einen eigenen Standort. 
		\item[FA160W] Teilnehmer können mittels eines Buttons Signale an die anderen Teilnehmer senden:
		\begin{itemize}
...
%TODO Nummern der Funktionalen Anforderungen überprüfen
	...
	\subsection{Terminverwaltung}
		...
		Ergebnis: Das Mitglied ist Teilnehmer des Termins , der Termin ist auf dem Gerät des Teilnehmers gespeichert.

	\subsection{Terminablauf}
	
		\item[T110] deckt ab FA140, FA150, FA160 \newline
		Automatischer Ablauf eines Termins. \newline
		Ergebnis: 30min vor dem Terminzeitpunkt werden alle Teilnehmer von dem Termin benachrichtigt  \newline
			15min vor dem Terminzeitpunkt ist die Karte für alle Teilnehmer verfügbar  \newline
			60min nach dem Terminzeitpunkt ist der Termin gelöscht (Keine Daten mehr zu diesem Termin weder auf 					dem Client noch auf dem Server)
...
%TODO Welche Funktionale Anforderung 
		...
		\item[T125]  deckt ab: \newline
		Gruppenmittelpunkt der Teilnehmer. \newline
		Ergebnis: Der Server sendet den Clients den Gruppenmittelpunkt.
