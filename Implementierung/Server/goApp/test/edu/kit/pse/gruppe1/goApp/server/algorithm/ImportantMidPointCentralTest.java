...
public class ImportantMidPointCentralTest {
    ...
    public class SimpleCentralTest {
        ...
        public void test() {
          ...
          ImportantMidPointCentral algo = new ImportantMidPointCentral(new DoublePoint(new double[] { 34, 53 }));
          ...
          assertTrue(longitude - 910920.6291 <= 0.0001 && longitude - 607291.75273333333333 >= -0.0001);
          assertTrue(latitude - 1322.5 <= 0.0001 && latitude - 899.333333333333 >= -0.0001);
